...
- Update other html files to work with base_generic.html
 - Make them like home.html where there is no head or body tags, just the block content
- Get Post object text, title, and maybe time to show on home and maybe User object elements to show on

Medium Priority:
- Configure the django site layout to loosely more accurately match the idea we had for it
